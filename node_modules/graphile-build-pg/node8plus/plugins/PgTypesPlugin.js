...
var PgTypesPlugin = function PgTypesPlugin(builder, {
  ...
  builder.hook("build", build => {
    ...
    const pgTweaksByTypeId = Object.assign( // '::text' rawTypes
    ...
    */
    ...
    const InetType = stringType(inflection.builtin("InternetAddress"), "An IPv4 or IPv6 host address, and optionally its subnet."); // pgExtendedTypes might change what types we use for things
