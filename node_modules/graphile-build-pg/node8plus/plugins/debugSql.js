...
function formatSQLForDebugging(sql) {
  let colourIndex = 0;
  let allowedColours = [_chalk.default.red, _chalk.default.green, _chalk.default.yellow, _chalk.default.blue, _chalk.default.magenta, _chalk.default.cyan, _chalk.default.white, _chalk.default.black];
