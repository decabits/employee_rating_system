...
function makeWrapResolversPlugin(rulesOrGeneratorOrFilter, rule) {
    ...
    return (builder, options) => {
        ...
        builder.hook("GraphQLObjectType:fields:field", (field, build, context) => {
            ...
            return Object.assign({}, field, { async resolve(...resolveParams) {
                    ...
                    const resolveInfoWithHelpers = Object.assign({}, resolveInfo, { graphile: fieldHelpers_1.makeFieldHelpers(build, context, graphqlContext, resolveInfo) });
